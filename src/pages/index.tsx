...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Paisa Banao `}</title>

        <meta
          name="description"
          content="Welcome to Paisa Banao, your trusted partner in navigating the stock market. We provide expert consulting for informed investment decisions."
        />
      </Head>
      ...
      <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Welcome to Paisa Banao, your trusted partner in navigating the stock market. We provide expert consulting for informed investment decisions.`}
            </Text>
        ...
        <Flex position="relative" flex={1}>
          <Image
            src={
              'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzdG9jayUyMG1hcmtldCUyQ2NvbnN1bHRpbmd8ZW58MHx8fHwxNjg4MjEyODY0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt={'Login Image'}
            objectFit={'cover'}
          />
